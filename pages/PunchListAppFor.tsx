...
import { usPunchListPersonas } from '../data/personas';

interface PunchListAppForProps {
  onSelectPersona: (slug: string) => void;
}

export const PunchListAppFor: React.FC<PunchListAppForProps> = ({ onSelectPersona }) => {
  return (
      ...
      <section className="py-16 md:py-24 px-4 text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl font-black leading-tight tracking-[-0.033em]">
            Punch list app for every role on the jobsite
          </h1>
          <p className="text-[#475569] text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Whether you're a GC managing closeout, a superintendent doing walkthroughs,
            or a sub fixing deficiencies — Snaglist fits your workflow.
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#181411] py-16 md:py-20">
        <div className="max-w-[960px] mx-auto px-4 text-center">
          <h2 className="text-white text-3xl md:text-4xl font-black leading-tight tracking-[-0.033em] mb-4">
            Closeout that doesn't eat your evenings.
          </h2>
